...
//        vc = YYLHistoryViewController()
        vc1.tabBarItem = item
        let viewController1 = UINavigationController(rootViewController:vc1)
        ...
        vc2.tabBarItem = item
        let viewController2 = UINavigationController(rootViewController:vc2)
        ...
        vc3.tabBarItem = item
        let viewController3 = UINavigationController(rootViewController:vc3)
        ...
        vc4.tabBarItem = item
        let viewController4 = UINavigationController(rootViewController:vc4)
        ...
        vc5.tabBarItem = item
        let viewController5 = UINavigationController(rootViewController:vc5)
